...
const ResponsiveLayout = () => {
  ...
  const [Contractors, setContractors] = useState([]); // State for vendor data
  ...
  const [formDataContractor, setFormDataContractor] = useState({
    fullName: '',
    email: '',
    phoneNumber: '',
    comingFrom: '',
  ...
  const handleInputChangeContractor = (e) => {
    const { name, value } = e.target;
    setFormDataContractor({ ...formDataContractor, [name]: value });
  };
  ...
  const handleSubmitContractor = (e) => {
    e.preventDefault();
    // Add the new vendor to the list
    setContractors([...Contractors, formDataContractor]);
    // Clear the form data
    setFormDataContractor({
      fullName: '',
      email: '',
      phoneNumber: '',
      comingFrom: '',
...
{content === 'contractor' && (
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <h2 style={{ fontSize: '20px', whiteSpace:'nowrap' }}>List of Contractors</h2>
                    <button
                      className="add-new-btn"
                      style={{
                        backgroundColor: '#FF8C00',
      ...
      {showForm && (
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h2 style={{ fontSize: '20px', color: '#FF8C00' }}>Add Contractors</h2>
            <FaTimes
              onClick={() => setShowForm(false)}
              style={{ cursor: 'pointer', fontSize: '20px', color: '#FF8C00' }}
            />
          </div>
          <form onSubmit={handleSubmitContractor}>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
              <div style={{ flex: '1 1 30%' }}>
                <label>Full Name</label>
                <input
                  type="text"
                  name="fullName"
                  value={formDataContractor.fullName}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
                    borderRadius: '5px',
              ...
              <div style={{ flex: '1 1 30%' }}>
                ...
                <input
                  type="email"
                  name="email"
                  value={formDataContractor.email}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
              ...
              <div style={{ flex: '1 1 30%' }}>
                ...
                <input
                  type="text"
                  name="phoneNumber"
                  value={formDataContractor.phoneNumber}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
              ...
              <div style={{ flex: '1 1 30%' }}>
                ...
                <input
                  type="text"
                  name="comingFrom"
                  value={formDataContractor.comingFrom}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
              ...
              <div style={{ flex: '1 1 30%' }}>
                ...
                <input
                  type="text"
                  name="company"
                  value={formDataContractor.company}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
              ...
              <div style={{ flex: '1 1 30%' }}>
                ...
                <input
                  type="text"
                  name="hostName"
                  value={formDataContractor.hostName}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
              ...
              <div style={{ flex: '1 1 30%' }}>
                ...
                <input
                  type="text"
                  name="purposeOfVisit"
                  value={formDataContractor.purposeOfVisit}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
              ...
              <div style={{ flex: '1 1 30%' }}>
                ...
                <input
                  type="text"
                  name="idType"
                  value={formDataContractor.idType}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
              ...
              <div style={{ flex: '1 1 30%' }}>
                ...
                <input
                  type="text"
                  name="idNumber"
                  value={formDataContractor.idNumber}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
              ...
              <div style={{ flex: '1 1 30%' }}>
                ...
                <input
                  type="date"
                  name="dateOfVisit"
                  value={formDataContractor.dateOfVisit}
                  onChange={handleInputChangeContractor}
                  style={{
                    width: '100%',
                    padding: '10px',
    ...
    <input
      type="time"
      name="entryTime"
      value={formDataContractor.entryTime}
      onChange={handleInputChangeContractor}
      style={{
        width: '100%',
        padding: '10px',
  ...
  <div style={{ flex: '1 1 30%' }}>
    ...
    <input
      type="time"
      name="exitTime"
      value={formDataContractor.exitTime}
      onChange={handleInputChangeContractor}
      style={{
        width: '100%',
        padding: '10px',
  ...
  <tbody>
    {Contractors.map((contractor, index) => (
      ...
      >
        ...
        <td>{contractor.dateOfVisit}</td>
        <td>{contractor.entryTime}</td>
        <td>{contractor.company}</td>
        <td>{contractor.purposeOfVisit}</td>
        <td>{contractor.idNumber}</td>
        <td>{contractor.exitTime}</td>
        <td style={{ textAlign: 'center', verticalAlign: 'middle' }}> {/* Center the icon */}
          <FaEye
            style={{ cursor: 'pointer', color: showDetails === index ? '#FF8C00' : 'gray' }}
            onClick={() => handleToggleDetails(index)}
